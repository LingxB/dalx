...
df = pd.read_csv('data/processed/seed_vectors_w_neu_16.csv', index_col='SEED', dtype={'LABELS': str})
...
#
# _x = w2vec_model['killer'].reshape(1,-1)
#
# svc.predict(_x)
#
...
score_df.to_csv('data/output/lexicon_table_dalx_17_thres0.7_C10.csv')
