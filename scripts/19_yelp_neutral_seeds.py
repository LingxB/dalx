...
vocabs = set(w2vec_model.wv.index2entity) # 363658 amazon: 43750

positive_seeds, negative_seeds, neutral_seeds = all_seeds_with_neutral() # 52, 58
positive_seeds = [w for w in positive_seeds if w in vocabs] # 31
negative_seeds = [w for w in negative_seeds if w in vocabs] # 35
...
train_df.to_csv('data/processed/yelp_seed_vectors_19.csv')
