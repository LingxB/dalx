...
variant = 'add' # 'avg' or 'add'


# TRAIN
# -----

df = pd.read_csv(f'data/processed/seed_aspect_vectors_11_{variant}.csv', index_col=['SEED', 'ASP'])
...
score_df.to_csv(f'data/output/lexicon_table_dalx_asp_12_thres0.7_C10_{variant}.csv')
